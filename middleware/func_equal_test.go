...
/*
NOTE: This file was taken from the Goji project:
	https://github.com/zenazn/goji/blob/master/web/func_equal.go

It is licensed under the original Goji license:
